...
from deutschland.zoll import rest
from deutschland.zoll.configuration import Configuration
from deutschland.zoll.exceptions import ApiException, ApiTypeError, ApiValueError
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.kategorien_get  # this is an instance of the class Endpoint
        api_instance.kategorien_get()  # this invokes api_instance.kategorien_get.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.kategorien_get.callable or self.callable in this class
